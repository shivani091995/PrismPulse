  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-gray-200 p-8">
      ...
      <div
        ...
        className="w-[1100px] h-[750px] border border-black rounded-t-xl flex flex-col justify-center items-center"
      >
      ...
      <div className="bg-gray-100 p-4 rounded-xl w-[800px] text-center shadow-md mt-10 mb-8">
        <p className="font-mono text-lg text-gray-800 font-bold">
          <span className="text-blue-800 font-extrabold text-lg">Hex Code:</span>{" "}
          {color}
        </p>
      </div>
    </div>
